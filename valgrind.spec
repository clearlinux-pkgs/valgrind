...
Source0  : https://sourceware.org/pub/valgrind/valgrind-3.25.1.tar.bz2
Source1  : https://sourceware.org/pub/valgrind/valgrind-3.25.1.tar.bz2.asc
...
%setup -q -n valgrind-3.25.1
cd %{_builddir}/valgrind-3.25.1
%patch -P 1 -p1
%patch -P 2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748384980
...
export GOAMD64=v2
%configure  || CFLAGS="-O2" ./configure --enable-static --enable-only64bit --enable-tls
make  %{?_smp_mflags}
...
/usr/include/valgrind/libvex_guest_riscv64.h
...
/usr/include/valgrind/vki/vki-linux-landlock.h
...
/usr/include/valgrind/vki/vki-posixtypes-riscv64-linux.h
...
/usr/include/valgrind/vki/vki-riscv64-linux.h
...
/usr/include/valgrind/vki/vki-scnums-riscv64-linux.h
...
/usr/libexec/valgrind/riscv64-cpu-valgrind-s1.xml
/usr/libexec/valgrind/riscv64-cpu-valgrind-s2.xml
/usr/libexec/valgrind/riscv64-cpu.xml
/usr/libexec/valgrind/riscv64-fpu-valgrind-s1.xml
/usr/libexec/valgrind/riscv64-fpu-valgrind-s2.xml
/usr/libexec/valgrind/riscv64-fpu.xml
/usr/libexec/valgrind/riscv64-linux-valgrind.xml
/usr/libexec/valgrind/riscv64-linux.xml
